...
#ifndef USPLATA_ZABORG_DELEGATE_H
#define USPLATA_ZABORG_DELEGATE_H
...
#include "tke_math.h"
//----------interfaces-------------
class USplata_zaborg_Delegate : public QSqlRelationalDelegate
{	
   Q_OBJECT
public:
		USplata_zaborg_Delegate( QObject *parent = 0 );
