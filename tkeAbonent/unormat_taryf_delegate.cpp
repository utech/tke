...
//~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
UNormat_taryf_Delegate::UNormat_taryf_Delegate(QObject *parent)
...
{
    if ( (index.column() == durationColumn_3) || (index.column() == durationColumn_4) || (index.column() == durationColumn_5) || (index.column() == durationColumn_6) || (index.column() == 7)){
...
//~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
QWidget *UNormat_taryf_Delegate::createEditor(QWidget *parent,
        const QStyleOptionViewItem &option,
        const QModelIndex &index) const
{	QSpinBox *spinbox;
    //year_part
	...
	else if ( (index.column() == durationColumn_3) || (index.column() == durationColumn_4) || (index.column() == durationColumn_5) || (index.column() == durationColumn_6) || (index.column() == 7)) {
        QDoubleSpinBox *double_spinbox = new QDoubleSpinBox(parent);
        double_spinbox->setMaximum ( 999999 );
...
//~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
void UNormat_taryf_Delegate::setEditorData(QWidget *editor,
                                  const QModelIndex &index) const
{
	QSpinBox *spinbox;
	//year_part
...
//~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
void UNormat_taryf_Delegate::setModelData(QWidget *editor,
...
//~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
void UNormat_taryf_Delegate::commitAndCloseEditor()
{
